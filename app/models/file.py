...
class DocumentRecord(SQLModel, table=True):
    ...
    act_type: Optional[str] = Field(default=None, index=True)
    issuer: Optional[str] = Field(default=None, index=True)
    reg_number: Optional[str] = Field(default=None, index=True)
    adoption_date: Optional[datetime] = Field(default=None, index=True)
